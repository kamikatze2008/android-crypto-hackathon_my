...
public class CryptoDataManager {
    ...
    public void getMarkets(@NonNull final DataRequestListener<Market[]> listener) {
        restServiceClient.getRetrofitInterface().getMarkets().observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Action1<Market[]>() {
                            @Override
    ...
    public void getAccountDetails(@NonNull final DataRequestListener<AccountDetails> listener) {
        restServiceClient.getRetrofitInterface().getAccountDetails().observeOn(AndroidSchedulers.mainThread())
                .subscribe(
    ...
    public void buyCrypto(String cryptoAsset, Trade trade, @NonNull final DataRequestListener<Order> listener) {
        restServiceClient.getRetrofitInterface().buyCrypto(cryptoAsset, trade).observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Action1<Order>() {
                            @Override
    ...
    public void sellCrypto(String cryptoAsset, Trade trade, @NonNull final DataRequestListener<Order> listener) {
        restServiceClient.getRetrofitInterface().sellCrypto(cryptoAsset, trade).observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Action1<Order>() {
                            @Override
                            public void call(Order order) {
    ...
    public void cancelOrderObservable(String cryptoAsset, String orderId, @NonNull final DataRequestListener<Order> listener) {
        restServiceClient.getRetrofitInterface().cancelOrder(cryptoAsset, orderId).observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Action1<Order>() {
                            @Override
                            public void call(Order order) {
